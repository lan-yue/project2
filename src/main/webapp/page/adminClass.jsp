        ...
        <div id="admin-wrap" class="fl">
            <div class="adminschool-title">
                <nav>
                    <ul class="clearfix">
                        ...
                        <li><a href="${pageContext.request.contextPath}/page/adminClass.jsp" class="active" id="bjgl">班级管理</a>
                        </li>
            ...
            <div class="changeAllWrap hide">
                <div class="changeWrap">
                    ...
                    <form name="changeClass" action="${pageContext.request.contextPath}/course/updateClass.do"
                          method="post">
...
<script>
        ...
        $.ajax({
            ...
            success: function (msg) {
                ...
                $(msg.data).each(function (k, v) {
                    ...
                    t = t + "<a href='javascript:updateClass(" + v.id + ",\"" + v.tname + "\")' class='change' >修改</a>&nbsp;";
                    t = t + "<a href='/course/deleteClass.do?tname=" + v.tname + "' onclick='javascript:return del(); class='del'>删除</a></td>";
                    t = t + "</tr>";
    ...
    //修改班级
    function updateClass($content1, $content2) {
        changePanel($content1, $content2);
    }
